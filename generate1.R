...
#disc <- matching.arbitrate(case.prepared, nA=50000,nB=40000, nu.A=0, phi.A=0, delta.A=0, nu.B=0, phi.B=0, delta.B=0, gamma=1)
# si on ne laisse pas assez de flex sur p
#disc <- matching.arbitrate(case.prepared, nA=50000,nB=40000, nu.A=0, phi.A=1, delta.A=0, nu.B=0, phi.B=0, delta.B=0, gamma=0)
