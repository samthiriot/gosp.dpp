...
# parents
cas1$sample.A <- create_sample(
                data=data.frame(
                        read.csv(
                            "/home/sam/projets/2017 parcimonious iterated picking/cas 1/logements.csv", 
                            sep=";", 
                            dec=",")
                        ),
                encoding = list(
...
cas1$sample.B <- create_sample(
                data=data.frame(
                        read.csv(
                            "/home/sam/projets/2017 parcimonious iterated picking/cas 1/foyers.csv", 
                            sep=";", 
                            dec=",")
                        ),
                encoding = list(
